...
const currentWord = words[currentIndex];
    ...
    return (
        ...
        <button className="btn back" onClick={handleChangeBack} disabled={currentIndex === 0}>Назад</button>
        ...
        <div className="word-card">
            ...
            <button className="btn nxt" onClick={handleChangeNext} disabled={currentIndex === words.length - 1}>Вперед</button>
        </div>
    );
}
